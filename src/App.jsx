...
import GreenCorridorPanel from './components/ui/GreenCorridorPanel';
...
function App() {
    ...
    return (
        <div className="w-full h-screen font-sans bg-bg-void overflow-visible text-white flex justify-center">
            {/* Max screen wrapper for Desktop Center Constraints */}
            <div className="w-full h-full max-w-[1200px] flex flex-col lg:flex-row relative overflow-visible">
