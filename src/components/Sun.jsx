        ...
        <group>
            <mesh ref={sunRef} frustumCulled={false}>
                ...
                <sprite scale={[0.9, 0.9, 1]}>
                    <spriteMaterial map={innerGlowTex} transparent opacity={0.25} blending={AdditiveBlending} depthWrite={false} />
                </sprite>

                {/* Outer corona sprite MUST scale equally */}
                <sprite scale={[1.6, 1.6, 1]}>
                    <spriteMaterial map={outerGlowTex} transparent opacity={0.10} blending={AdditiveBlending} depthWrite={false} />
                </sprite>
            </mesh>
