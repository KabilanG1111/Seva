...
import { Group, SphereGeometry, MeshPhongMaterial, Mesh, MeshBasicMaterial, IcosahedronGeometry, PointLight, PlaneGeometry, RingGeometry, DoubleSide, Color, Sprite, SpriteMaterial, CanvasTexture, AdditiveBlending } from 'three';
