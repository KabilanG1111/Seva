        ...
        >
            <div className="w-full max-w-sm flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <select defaultValue="" className="w-full bg-[#0A0D1A] border-[0.5px] border-white/20 rounded-md p-4 text-white font-mono focus:outline-none focus:border-white/50 appearance-none">
                        <option value="" disabled className="text-white/20">BLOOD TYPE (PRAAN)</option>
                        <option value="o+">O POSITIVE</option>
                        <option value="o-">O NEGATIVE</option>
                        <option value="a+">A POSITIVE</option>
                    </select>

                    <select defaultValue="en" className="w-full bg-[#0A0D1A] border-[0.5px] border-white/20 rounded-md p-4 text-white font-mono focus:outline-none focus:border-white/50 appearance-none">
