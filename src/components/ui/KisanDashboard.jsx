                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div className="kd-metrics-grid">
                        <div className="kd-metric-box">
                            ...
                            <span className="orbitron kd-metric-val">42<span style={{ fontSize: '24px', color: '#00aa44' }}>%</span></span>
                            <div style={{ height: '3px', background: '#003300', marginTop: 'auto' }}>
                                <div style={{ width: '42%', height: '100%', background: '#22ff88' }}></div>
                            </div>
                        </div>
                        <div className="kd-metric-box">
                            <span className="text-gray" style={{ fontSize: '11px', letterSpacing: '2px' }}>DISEASE PROBABILITY</span>
                            <span className="orbitron kd-metric-val" style={{ color: '#ffaa00', textShadow: '0 0 15px rgba(255,170,0,0.4)' }}>14<span style={{ fontSize: '24px', color: '#aa6600' }}>%</span></span>
                            <div style={{ height: '3px', background: '#003300', marginTop: 'auto' }}>
                                <div style={{ width: '14%', height: '100%', background: '#ffaa00' }}></div>
                            </div>
                        </div>
                        <div className="kd-metric-box">
                            <span className="text-gray" style={{ fontSize: '11px', letterSpacing: '2px' }}>FIELD TEMPERATURE</span>
                            <span className="orbitron kd-metric-val" style={{ color: '#00e0ff', textShadow: '0 0 15px rgba(0,224,255,0.4)' }}>28<span style={{ fontSize: '24px', color: '#0088aa' }}>°C</span></span>
                            <div style={{ height: '3px', background: '#003300', marginTop: 'auto' }}>
                                <div style={{ width: '60%', height: '100%', background: '#00e0ff' }}></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="kd-panel">
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px' }}>
                                <div>
                                    ...
                                    <div className="orbitron text-green" style={{ fontSize: '40px' }}>₹2,445<span style={{ fontSize: '18px', color: '#00aa44' }}>/Q</span></div>
                                </div>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'linear-gradient(90deg, #003300, transparent)', borderLeft: '4px solid #00e0ff', padding: '16px 20px' }}>
                                <div className="text-cyan orbitron" style={{ fontSize: '16px', letterSpacing: '2px' }}>HOLD FOR 12 DAYS</div>
                                <div className="text-gray uppercase" style={{ fontSize: '10px', letterSpacing: '1px' }}>Predicted peak: ₹2,600</div>
                            </div>
                        </div>
                    </div>
